...
// the watch: what runs without him and what still needs his hands. This is the head of that section;
// Balance follows it. The old thesis lives here now, as the one dimension of the practice this section
// is about.
export default (() => {
