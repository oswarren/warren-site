...
export default (() => {
  const MakeOne: QuartzComponent = ({ displayClass }: QuartzComponentProps) => (
    <div class={classNames(displayClass, "makeone")}>
      <p class="lead">Click one, or say your own. Whatever you pick, it runs on its own once it exists.</p>
      ...
      <div class="own">
        ...
        />
        <div class="owns">
          <button class="more" type="button" id="more">Show me other ones</button>
          <button class="more" type="button" id="dunno">I have no idea</button>
        </div>
      ...
      <div class="built" id="built">
        ...
        <p class="thinking" id="thinking" hidden>Building it<span>...</span></p>

        <div class="spec">
          <div class="step" id="st0"><span class="lead">It reads</span><span class="what" id="w0"></span></div>
          <div class="step" id="st1"><span class="lead">It decides</span><span class="what" id="w1"></span></div>
          <div class="step" id="st2"><span class="lead">It sends you</span><span class="what" id="w2"></span></div>
          <div class="step" id="st3"><span class="lead">Your part</span><span class="what" id="w3"></span></div>
        </div>
        ...
        <div class="ask" id="ask">
          <div class="fields">
            <input type="text" id="who" placeholder="your name" autocomplete="name" aria-label="Your name" />
            <input type="email" id="mail" placeholder="where to reach you" autocomplete="email" aria-label="Your email" />
          </div>
          <button class="send" type="button" id="send">Build mine for real</button>
          <button class="alt" type="button" id="again">Build it a different way</button>
          <p class="fineprint" id="fine">
            Built one at a time, by me. Once it is yours it runs without you, and it keeps running whether
            or not you think about it again.
          </p>
      ...
      <div class="shelf">
        <h2>Built so far</h2>
        <p class="intro">
          Every one of these belongs to the person who asked for it. It runs for them, and it links to
          their page, not mine.
        </p>
        <div class="rows">
          {SHELF.map((s) => (
...
.makeone button.want { font-size: 19px; }
...
.makeone input {
  ...
  padding: 8px 0; font-family: inherit; font-size: 19px; color: var(--dark); width: 100%;
}
...
.makeone .yours { margin: 6px 0 0; font-size: 28px; line-height: 1.2; color: var(--dark); max-width: 26ch; }
...
.makeone .pivot .instead { margin: 0; font-size: 21px; line-height: 1.25; color: var(--dark); max-width: 42rem; }
...
.makeone .step .what { font-size: 18px; line-height: 1.4; color: var(--dark); max-width: 38ch; }
...
.makeone .firstrun p { margin: 0; font-size: 17px; line-height: 1.45; color: var(--dark); }
...
.makeone .send {
  appearance: none; align-self: flex-start; background: var(--dark); color: var(--light);
...
.makeone .row .name { font-size: 17px; color: var(--dark); }
